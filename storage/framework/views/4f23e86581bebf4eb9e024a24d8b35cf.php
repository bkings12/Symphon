            ...
            <div style="display: grid; grid-template-columns: 1fr; gap: 3rem; align-items: center;">
                ...
                <div style="display: flex; flex-direction: column; gap: 2rem;">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 1rem;">
                        <?php if(Route::has('register')): ?>
                            <a href="<?php echo e(route('register')); ?>" style="padding: 1rem 2rem; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border-radius: 0.5rem; transition: opacity 0.3s; box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1); text-align: center; font-weight: 600;">
                                Start Free Trial
                            </a>
                        <?php elseif(Route::has('login')): ?>
                            <a href="<?php echo e(route('login')); ?>" style="padding: 1rem 2rem; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border-radius: 0.5rem; transition: opacity 0.3s; box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1); text-align: center; font-weight: 600;">
                                Start Free Trial
                            </a>
                        <?php else: ?>
    ...
    <footer style="background-color: #f9fafb; padding: 3rem 1rem;">
        <div style="max-width: 80rem; margin: 0 auto;">
            ...
            <div style="border-top: 1px solid #e5e7eb; padding-top: 2rem; text-align: center; color: #4b5563;">
                <p>&copy; <?php echo e(date('Y')); ?> Symphony. All rights reserved.</p>
            </div>
        </div>
    </footer>
...
<?php /**PATH /home/bryan/Symphony/resources/views/welcome.blade.php ENDPATH**/ ?>
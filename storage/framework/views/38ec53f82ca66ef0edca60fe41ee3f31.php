...
<div class="pos-container">
        ...
        <div class="pos-header">
            <div class="pos-header-content">
                <div>
                    ...
                    <p class="pos-header-subtitle"><?php echo e(auth()->user()->pharmacy?->name ?? 'Symphony Pharmacy'); ?></p>
                </div>
                <div class="pos-header-actions">
                    <!--[if BLOCK]><![endif]--><?php if($selectedCustomer): ?>
                        <div class="pos-customer-badge">
                            <p>Customer</p>
                            <p><?php echo e($selectedCustomer['name']); ?></p>
                        </div>
                    ...
                    <button 
                        ...
                        💳 Checkout • <?php echo e(format_currency($cartTotal)); ?>
                        ...
                        <div class="pos-search-results">
                            <div style="padding: 1rem 1.5rem; border-bottom: 2px solid var(--gray-200); background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%);">
                                <p style="margin: 0; font-weight: 700; color: var(--gray-700); font-size: 0.9375rem;">
                                    <!--[if BLOCK]><![endif]--><?php if(strlen($search) >= 2): ?>
                                        🎯 Found <?php echo e(count($searchResults)); ?> <?php echo e(count($searchResults) == 1 ? 'medicine' : 'medicines'); ?>
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $searchResults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="pos-search-result-item">
                                    <div style="flex: 1;">
                                        <p class="pos-result-name"><?php echo e($result['name']); ?></p>
                                        <p class="pos-result-details"><?php echo e($result['generic_name']); ?></p>
                                        <p class="pos-result-meta">SKU: <?php echo e($result['sku']); ?> • Stock: <?php echo e($result['stock_quantity']); ?> <?php echo e($result['unit']); ?></p>
                                    </div>
                                    <div style="text-align: right;">
                                        <p class="pos-result-price"><?php echo e(format_currency($result['selling_price'])); ?></p>
                                    </div>
                                    <button 
                                        type="button"
                                        wire:click="addToCart(<?php echo e((int)$result['id']); ?>)"
                ...
                <div class="pos-card" style="margin-top: 1.5rem;">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if(!$selectedCustomer): ?>
                        <div style="position: relative;">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if(count($customerResults) > 0): ?>
                                <div style="position: absolute; z-index: 10; width: 100%; margin-top: 0.75rem; background: white; border: 2px solid var(--gray-200); border-radius: 1rem; box-shadow: 0 15px 40px rgba(0,0,0,0.2); max-height: 20rem; overflow-y: auto;">
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $customerResults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <button 
                                            ...
                                            <p style="font-weight: 700; margin: 0; color: var(--gray-900); font-size: 1.0625rem;"><?php echo e($customer['name']); ?></p>
                                            <p style="font-size: 0.875rem; color: var(--gray-600); margin: 0.25rem 0 0 0;">📞 <?php echo e($customer['phone']); ?> • ✉️ <?php echo e($customer['email']); ?></p>
                                        </button>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                </div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <?php else: ?>
                        <div class="pos-customer-selected">
                            <p style="font-weight: 700; color: var(--gray-900); margin: 0; font-size: 1.25rem;"><?php echo e($selectedCustomer['name']); ?></p>
                            <p style="font-size: 1rem; color: var(--gray-600); margin: 0.5rem 0 0 0;">📞 <?php echo e($selectedCustomer['phone']); ?></p>
                        </div>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                </div>
                    ...
                    <?php else: ?>
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="pos-cart-item">
                                    <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 1rem;">
                                        <div style="flex: 1;">
                                            <p class="pos-cart-item-name"><?php echo e($item['name']); ?></p>
                                            <p class="pos-cart-item-sku"><?php echo e($item['sku']); ?></p>
                                        </div>
                                        <button 
                                    ...
                                    <div style="display: flex; align-items: center; justify-content: space-between;">
                                        <div style="display: flex; align-items: center; gap: 0.75rem;">
                                            ...
                                            <input 
                                                ...
                                                min="1"
                                                max="<?php echo e($item['stock_available']); ?>"
                                        ...
                                        <p style="font-weight: 800; color: var(--gray-900); font-size: 1.25rem; margin: 0;">
                                            <?php echo e(format_currency($item['selling_price'] * $item['quantity'])); ?>
                        ...
                        <div class="pos-cart-totals">
                            <div class="pos-cart-total-row">
                                <span>Subtotal</span>
                                <span><?php echo e(format_currency($cartSubtotal)); ?></span>
                            </div>
                            <!--[if BLOCK]><![endif]--><?php if($discountAmount > 0): ?>
                                <div class="pos-cart-total-row" style="color: var(--success);">
                                    <span>💸 Discount</span>
                                    <span>-<?php echo e(format_currency($discountAmount)); ?></span>
                                </div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            <div class="pos-cart-total-row">
                                <span>Tax (<?php echo e($taxRate * 100); ?>%)</span>
                                <span><?php echo e(format_currency($taxAmount)); ?></span>
                            </div>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                        ...
                        <div class="pos-modal-info-box">
                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                ...
                                <span style="font-size: 2rem; font-weight: 800; color: var(--gray-900);"><?php echo e(format_currency($cartTotal)); ?></span>
                            </div>
                        </div>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($change > 0): ?>
                                <div class="pos-modal-change-box">
                                    <div style="display: flex; justify-content: space-between; align-items: center;">
                                        ...
                                        <span class="pos-modal-change-amount"><?php echo e(format_currency($change)); ?></span>
                                    </div>
                                </div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <!--[if BLOCK]><![endif]--><?php if(isset($showReceiptModal)): ?>
        <!--[if BLOCK]><![endif]--><?php if($showReceiptModal && isset($lastSale) && $lastSale): ?>
            ...
            <div class="pos-modal-content" style="max-width: 500px;" id="receipt-modal">
                <div class="pos-modal-inner">
                    ...
                    <div class="pos-modal-receipt-content">
                        <?php if (isset($component)) { $__componentOriginalb32c821661e36eb2e655a976ee5ad7bd = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalb32c821661e36eb2e655a976ee5ad7bd = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.receipt','data' => ['sale' => $lastSale,'saleItems' => $lastSaleItems,'customer' => $lastCustomer,'payment' => $lastPayment]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('receipt'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['sale' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($lastSale),'saleItems' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($lastSaleItems),'customer' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($lastCustomer),'payment' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($lastPayment)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalb32c821661e36eb2e655a976ee5ad7bd)): ?>
<?php $attributes = $__attributesOriginalb32c821661e36eb2e655a976ee5ad7bd; ?>
<?php unset($__attributesOriginalb32c821661e36eb2e655a976ee5ad7bd); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalb32c821661e36eb2e655a976ee5ad7bd)): ?>
<?php $component = $__componentOriginalb32c821661e36eb2e655a976ee5ad7bd; ?>
<?php unset($__componentOriginalb32c821661e36eb2e655a976ee5ad7bd); ?>
<?php endif; ?>
                    </div>
...
<script>
    ...
    document.addEventListener('keydown', (e) => {
        ...
        if (e.key === 'Enter' && barcodeBuffer.length > 0) {
            window.Livewire.find('<?php echo e($_instance->getId()); ?>').call('scanBarcode', barcodeBuffer);
            barcodeBuffer = '';
            return;
        }
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/bryan/Symphony/resources/views/livewire/pos-component.blade.php ENDPATH**/ ?>